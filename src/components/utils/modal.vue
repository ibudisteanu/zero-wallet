<template>
  ...
  <div :class="`${open ? 'modal fade show' : ''}`"
       :style="` ${open ? 'display: flex !important; z-index: '+this.zIndex : 'display: none'}`">
      ...
      <div class="modal-dialog modal-dialog-centered" :style="`z-index: ${this.zIndex}`">
        <div class="modal-content position-relative">
          <div class="position-absolute top-0 end-0 mt-2 me-2 z-index-1">
            <button v-if="closeButton" class="btn-close btn btn-sm btn-circle d-flex flex-center transition-base"
