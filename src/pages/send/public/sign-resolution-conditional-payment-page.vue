        ...
        <wizard :titles="{
            ...
            <template v-slot:tab_0>
                <div class="pb-2">
                    ...
                    <div v-if="$store.getters.validateHash(txId)" class="invalid-feedback d-block">{{ $store.getters.validateHash(txId) }}</div>
                </div>
                ...
                <div class="pb-2">
                    ...
                    <div v-if="$store.getters.validateNumber(payloadIndex)" class="invalid-feedback d-block">{{ $store.getters.validateNumber(payloadIndex) }}</div>
                </div>
            </template>
    ...
    methods: {
        ...
        async updateRouteParams(to = this.$route){
            try{
                ...
                if (to.query.txId !== undefined) this.txId = to.query.txId.trim()
                else this.txId = ""

                if (to.query.payloadIndex !== undefined) this.payloadIndex = to.query.payloadIndex.trim()
                ...
                if (to.query.privateKey !== undefined) this.privateKey = to.query.privateKey
