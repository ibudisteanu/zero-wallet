<template>
    ...
    <layout>
        ...
        <layout-title icon="fas fa-money-check-alt" title="Private Send Funds">Send Funds Privately to another address</layout-title>

        <zether-tx :public-key="publicKey" :init-recipients="initRecipients" :init-amounts="initAmounts" :init-assets="initAssets"
