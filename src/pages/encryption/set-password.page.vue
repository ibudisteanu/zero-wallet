<template>
  ...
  <layout>
    ...
    <layout-title icon="fas fa-lock" title="Encrypt wallet">
      Set a password for your wallet. The password will be necessary on your machine to open and use the wallet.
    </layout-title>
        ...
        <div class="row pt-4" v-if="$store.state.settings.expert">
          <div class="col-12 col-sm-6">
            <label>
              ...
              <i class="fas fa-question ms-1" v-tooltip.bottom="'The harder the encryption is, the harder for brute force is to crack it'"/>
            </label>
          ...
          <div class="col-12 col-sm-6">
            <label>
              Password Strength
              <i class="fas fa-question ms-1" v-tooltip.bottom="'Avoid using guessable passwords as dictionary attacks can crack it.'"/>
            </label>
